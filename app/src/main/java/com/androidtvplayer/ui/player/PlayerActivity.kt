...
class PlayerActivity : FragmentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        stream = Gson().fromJson(
            intent.getStringExtra(EXTRA_STREAM_JSON),
    ...
    private fun updateCacheStatus() {
        ...
        cacheStatusText.text = "Cache: ${stats.usedMb}MB / ${stats.maxMb}MB  [${stats.storagePath.substringAfterLast("/")}]"
    }
